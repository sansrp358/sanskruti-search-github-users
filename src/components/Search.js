...
const Search = () => {
  ...
  //To get the things from the Global Context.
  ...
  return(
    <section className="section">
      ...
      <ErrorWrapper>
        ...
        <h3 style={{color:"#111"}}><b>Requests : {requests}  / 60</b></h3>
      </Wrapper>
...
//I am surely going to acheive my dream and make my parents proud !